...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "successful completion of load hides indicator")
    ...
    func test_feedImageView_configuresViewCorrectlyWhenCellBecomingVisibleAgain() {
        ...
        XCTAssertTrue(view0!.isShowingImageLoadingIndicator, "Expected loading indicator when view becomes visible again")
    ...
    private func makeSUT(
        ...
        let sut = createAndTrackMemoryLeaks(FeedUIComposer.feedComposedWith(feedLoader: loader.loadPublisher, imageLoader: loader.loadImageDataPublisher, selection: selection), file: file, line: line)
        return (sut, loader)
    }
