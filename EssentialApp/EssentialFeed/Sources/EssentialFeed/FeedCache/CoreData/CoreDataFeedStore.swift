...
public final class CoreDataFeedStore {
    ...
    public init(storeURL: URL, bundle: Bundle = EssentialFeedBundle.get) throws {
        guard let model = NSManagedObjectModel.with(name: CoreDataFeedStore.modelName, in: bundle) else {
